...
/**
 * Request payload used to update outlet details.
 *
 * <p>The API currently treats outlet updates as full replacements for the core
 * editable outlet fields. This keeps validation rules explicit and avoids
 * partial-update ambiguity while the domain is still small.</p>
 */
